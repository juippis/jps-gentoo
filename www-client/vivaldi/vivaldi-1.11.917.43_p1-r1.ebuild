...
RDEPEND="
	...
	x11-libs/libXtst
	x11-libs/pango[X]
	proprietary-codecs? ( media-video/ffmpeg:0/55.57.57[chromium] )
"
...
src_install() {
	...
	if use proprietary-codecs ; then 
		rm "${D}"/opt/vivaldi/lib/libffmpeg.so

		dosym ../../../usr/$(get_libdir)/chromium/libffmpeg.so /opt/vivaldi/lib/libffmpeg.so
