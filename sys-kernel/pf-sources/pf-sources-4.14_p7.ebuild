...
DESCRIPTION="Desktop-oriented Linux kernel fork that incorporates PDS CPU scheduler, graysky's GCC patch, UKSM, BFQ fixes and blk-mq performance patches"
...
src_prepare(){
	epatch "${DISTDIR}/${P}.patch" || die "Applying ${P}.patch failed."
